...
<body>
    ...
    <header id="head">
        ...
        <div class="menu-list" id="menu-items">
            ...
            <ul class="list-items">
                <li><a href="{{ route('home') }}">home <img src="{{ asset('data/images/arrow-24-xxl.png') }}" alt=""
                            class="arrow"> </a></li>
                <li><a href="{{ route('contact') }}">contact <img src="{{ asset('data/images/arrow-24-xxl.png') }}"
                            alt="" class="arrow"></a></li>
                <li><a href="{{ route('blog') }}">blog <img src="{{ asset('data/images/arrow-24-xxl.png') }}" alt=""
                            class="arrow"></a></li>
                <li><a href="{{ route('about') }}">about <img src="{{ asset('data/images/arrow-24-xxl.png') }}" alt=""
                            class="arrow"></a></li>
                <li><a href="{{ route('how_it_works') }}">how it works <img
                            src="{{ asset('data/images/arrow-24-xxl.png') }}" alt="" class="arrow"></a></li>
            </ul>
        </div>
    ...
    <section class="get-in-touch-section">
        ...
        <div class="get-in-touch-img-container">
            <img src="{{ asset('data/images/live-chat-with-customer-service-vector-illustration_7087-1844.jpg') }}"
                alt="" class="get-in-touch-img">
        </div>
