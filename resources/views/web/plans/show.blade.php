...
<div class="col-sm-6 mx-auto mt-5 mb-3">
    ...
    <div class="card">
        <div class="card-header">
            <h1 class="investment-header">Bitcoin Investment Plans
        ...
        <div class="card-body">
            <h4 class="card-title"><b>Wallet Address: <span class="text-primary"><i>bc1qdzcytx3swph5l2udgwfchy7swzdym5kjw6kg76</i></span></b></h4>
            <hr>
            <h5 class="card-title"><b><i>Invesment Details</i> :</b></h5>
