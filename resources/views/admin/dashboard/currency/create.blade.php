...
<div class="">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Create Currency</h4>
...
<div class="card ">
    <div class="card-body">
        <h4 class="card-title mb-4">Add Currency</h4>
        ...
        <form action="{{route('admin.currencies.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="mb-3 col-sm-6">
                    ...
                    <input type="text" name="name" value="{{ old('name')  }}" class="form-control" id="" placeholder="Enter new currency name">
                </div>
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="short_name" value="{{ old('short_name')  }}" class="form-control" placeholder="Shortname must be in uppercase letter e.g USD, NGN">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="mb-3">
